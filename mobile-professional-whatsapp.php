...
if (!empty($_GET['agent'])){
  if ($agent = get_agent($link, $_GET['agent'])){
    $_SESSION['proxy'] = $_SESSION['agent'] = $agent['id'];
  }
} else if (!empty($_GET['ref'])){  // If user is referred by an agent
  if ($agent = get_agent($link, "", $_GET['ref'])){
    $_SESSION['agent'] = $agent['id'];
  }
}
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container pb-5">
      ...
      <h1 class="mt-4 mb-3">Mobile Professional Course
      </h1>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="row">
            <p class="firstp">
              Work from anywhere, learn how to use your Mobile phone to collaborate with your team mates, while accessing vital office documents in the Cloud
              <div class="row p-3">
                <ul class="hidlist col-md-12">
          ...
          <div id="details" class="row mt-4 mb-4">
            ...
            <div class="benefits col-md-5">
              ...
              <div data-toggle="modal" data-target="#payModal">
                <a href="https://wa.me/<?php echo !empty($agent['phone']) ? $agent['phone'] : "2348033954301"; ?>?text=I'm%20interested%20in%20your%20Mobile%20Professional%20Classes" class="btn btn-success m-1"><i class="fa fa-whatsapp fa-lg"></i> Register for Classes</a>
              </div>
