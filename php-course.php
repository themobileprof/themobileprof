					...
					<p class="firstp">
						...
						<div class="row p-3">
							...
							<ul class="hidlist col-md-9 col-12">
								...
								<li><i class="fa fa-check-square"></i> Terminal MySQL
									<ul>
										<li>MySQL is the most popular database server for web applications. Learn how to setup databases and manipulate tables on your Linux Commandline <br>
