...
<head>
	...
	<title>MobileOps DevOps Training - Level 2</title>
...
<body>
	...
	<div class="container py-5">
		...
		<h1 class="mt-4 mb-3">6 Weeks DevOps Code Camp - Level 2
		</h1>
		...
		<ol class="breadcrumb bg-white">
			...
			<li class="breadcrumb-item active">MobileOps - Level 2</li>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="row">
					...
					<p class="firstp">
						<img src="assets/img/proud_coder.png" alt="Programmer" class="img-fluid">

						<div>
							<h3>Reserve a Seat Now</h3>
							<a href="tel:+2348033954301" class="btn btn-danger m-1 text-white">
								Reserve a Seat</a>
						</div>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									<td>Week 1</td>
									<td>Google Cloud Introduction</td>

								</tr>
								<tr>
									<td>Week 2</td>
									<td>VM Instances in GCloud</td>
								</tr>
								<tr>
									<td>Week 3</td>
									<td>Networking in GCloud</td>
								</tr>
								<tr>
									<td>Week 4</td>
									<td>Security and Firewalls in GCloud</td>
								</tr>
								<tr>
									<td>Week 5</td>
									<td>Load Balancing in GCloud</td>
								</tr>
								<tr>
									<td>Week 6</td>
									<td>Bringing it all Together in GCloud</td>
								</tr>
						...
						<div class="row p-3">
							<div class="">
								<div class="m-2"><img src="assets/slide/15.png" class="img-fluid" alt=""></div>
								<div class="m-2"><img src="assets/slide/16.png" class="img-fluid" alt=""></div>
								<div class="m-2"><img src="assets/slide/17.png" class="img-fluid" alt=""></div>
							</div>
						</div>
				...
				<div id="details" class="row mt-4 mb-4">
					<div class="bg-primary col-md-12 text-white pt-3 mb-3 rounded-top">
						...
						<h3 class="text-light">Online Classes</h3>

					</div>
					<div class="col-md-5">
						<div>
							<div class="display-4 text-success">N150,000</div>
						</div>
						<ul class="list-group list-group-flush">
							<li class="list-group-item"><strong>Duration:</strong> 6 Weeks</li>
							<li class="list-group-item"><strong>Days:</strong> Monday, Wednesday, Friday</li>
						</ul>
					</div>
					<div class="benefits col-md-7">
						<h3 class="text-danger">To Qualify for the class, you first have to take the <a href="mobileops-level1.php">MobileOps Level 1 class</a>. <br>
						OR pass the Level 1 Test (Please <a href="mailto:themobileprof.com@gmail.com">contact us</a> for test details). </h3>
				...
				<div class="card mt-2">
					...
					<div class="card-body hidlist">
						...
						<div>
							...
							<hr>
							<div>For our Advanced Laravel and VueJS Classes, call us for details</div>
							<a href="tel:+234-803-395-4301" class="btn btn-primary m-1">
								Call to Register for Class</a>
						</div>
					</div>
				</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="payModalLabel">Mobile Web Design Class</h5>
	...
	<footer class="py-5 bg-dark">
		<div class="container">
			<p class="m-0 text-center text-white">Copyright &copy; TheMobileProf.com 2019</p>
		</div>
		<!-- /.container -->
	</footer>
